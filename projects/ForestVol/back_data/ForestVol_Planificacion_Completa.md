...
Comparativa entre nueve métodos de medición en 47 acopios demostró que los métodos fotogramétricos logran precisiones volumétricas comparables a sistemas LiDAR, sin necesidad de sensores de tiempo de vuelo. Justificación empírica del uso de una guía física de 100×100 cm para escalar los modelos.
...
| ----- | ----- | ----- | ----- | ----- |
| **1** | Captura Fotográfica | Vuelo de dron con cámara RGB estándar sobre el castillo de madera. La guía de calibración (100×100 cm) debe estar visible en el acopio. | Set de imágenes JPG/PNG (≥20 imágenes, ≥24 MP) | Operación en Terreno |
...
| **3** | Calibración Espacial | OpenCV detecta automáticamente los contornos de la guía 100×100 cm. Calcula la relación px/cm y genera la matriz de transformación. Si no detecta guía, alerta al operador. | Escala métrica aplicada al modelo. Error de escala ≤5%. | RF-03, RF-04, RF-05 |
...
| Guía de Calibración | Marco físico de 100×100 cm dispuesto en el acopio durante la captura. |
...
| Error de escala métrica | ≤ 5% (guía de 100 cm) | Medición del lado de la guía en el modelo 3D |
